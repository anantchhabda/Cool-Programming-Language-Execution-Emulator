...
AWORD read_memory(int address) {
	...
	// FIGURE OUT WHICH CACHE LOCATION FOR THE PARTICULAR ADDRESS
...

{
	...
	// BEFORE WRITING, CHECK IF WE ARE RE-UPDATING THE SAME ADDRESS. 
...
//  FETCH THE NEXT INSTRUCTION TO BE EXECUTED
	...
	switch(instruction){
		...
		case I_POPA:
			...
			value1 = read_memory(SP);
			SP++;
			write_memory(our_address,value1);
			PC++;
			break;
...
void initialise_cache(void)
{
	...
	cache_memory[i][2] = 1;} //initialise all locations as initially dirty
}
